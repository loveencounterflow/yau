...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.listen = function(channel, ctx, listener) {
    [channel, ctx, listener] = this._get_ccl(...arguments);
